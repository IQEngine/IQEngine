...
async def import_datasources_from_env(environment_variable_name="IQENGINE_CONNECTION_INFO"):
    """
    ...
    try:
        ...
        for connection in connections:
            if await datasource_repo.datasource_exists(connection["accountName"], connection["containerName"]):
                continue
