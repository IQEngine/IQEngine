...
from samples import get_custom_params, get_from_samples_b64, get_from_samples_cloud, validate_samples
...
async def get_core_plugin_definition(plugin_name: str):
    try:
        ...
        raise fastapi.HTTPException(
            status_code=404, detail="Plugin defintion could not be generated"
        )
        ...
        raise fastapi.HTTPException(
            status_code=404, detail="Plugin does not exist"
        )
