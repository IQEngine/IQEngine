...
export const SampleSources: SourceObject[] = [
  {
    ...
    description:
      'A collection of example SigMF recordings hosted by the GNU Radio project (contact Marc to have your recordings added)',
  ...
  },
  {
    ...
    description:
      'A collection of example SigMF recordings hosted by the IQEngine project (contact Marc to have your recordings added)',
    icon: '/default_spectogram.jpeg',
    container: 'test',
    storageAccount: 'test',
    recordingsCount: 200,
