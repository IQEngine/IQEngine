          ...
          <div className="container flex mb-40 sm:navbar mb-10 bg-base-100" id="topRow">
            <div className="md:hidden navbar-start">
              <div className="md:hidden dropdown">
                ...
                <ul tabIndex={0} className="md:hidden menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                  <li>
                    <Link to="/" onClick={() => {}}>
                      Home
                    </Link>
            ...
            <Link to="/" onClick={() => {}}>
              ...
              <Feature flag="displayInternalBranding">
                <img src="/internalbrandingeg.jpg" alt="Internal branding logo" className="md:w-32 md:h-32 mr-8 sm:w-20 sm:h-20" />
              </Feature>
