...
describe('DevTest Spectrogram Tests', () => {
  ...
  test.each([
    ...
    'calcFfts should return correct FFT for standard inputs: %s',
    async (comment, fftSize, spectrogramHeight, frequency, sample_rate, windowFunction) => {
      ...
      const fftsConcatenated = calcFfts(sampleIQData, fftSize, windowFunction, spectrogramHeight);
  ...
  test.each([
    ...
    async (comment, spectrogramHeight, fftSize, frequency, sampleRate, windowFunction) => {
      ...
      const fftResult = calcFfts(sampleIQData, fftSize, windowFunction, spectrogramHeight);
  ...
  test.each([
    ['min=NaN', 1000, 128, NaN, 10.0, COLORMAP_DEFAULT, SampleType.MultipleBuckets],
    ['max=Nan', 1000, 128, -10.0, NaN, COLORMAP_DEFAULT, SampleType.MultipleBuckets],
    ['min>max', 1000, 256, -20.0, -30.0, 'jet', SampleType.MultipleBuckets],
    ['min==max', 1000, 512, -60.0, -60.0, 'plasma', SampleType.MultipleBuckets],
    ['fftSize==0', 1000, 0, -40.0, -10.0, 'jet', SampleType.MultipleBuckets],

    ['min=NaN', 1000, 128, NaN, 10.0, COLORMAP_DEFAULT, SampleType.WhiteBox],
    ['max=Nan', 1000, 128, -10.0, NaN, COLORMAP_DEFAULT, SampleType.WhiteBox],
    ['min>max', 1000, 256, -20.0, -30.0, 'jet', SampleType.WhiteBox],
    ['min==max', 1000, 512, -60.0, -60.0, 'plasma', SampleType.WhiteBox],
    ['fftSize==0', 1000, 0, -40.0, -10.0, 'jet', SampleType.WhiteBox],
  ])(
  ...
  test.each([
    ['128,multi-dB', 1000, 128, -40.0, 0.0, COLORMAP_DEFAULT, SampleType.MultipleBuckets],
    ['256,multi-dB', 1000, 256, -30.0, -20.0, 'jet', SampleType.MultipleBuckets],
    ['512,multi-dB', 1000, 512, -60.0, 10.0, 'plasma', SampleType.MultipleBuckets],
    ['defaults,multi-dB', 1000, 1024, -40.0, -10.0, COLORMAP_DEFAULT, SampleType.MultipleBuckets],
    ['defaults,jet,multi-dB', 1000, 1024, -40.0, -10.0, 'jet', SampleType.MultipleBuckets],
    ['2048,jet,multi-dB', 1000, 2048, -40.0, -10.0, 'jet', SampleType.MultipleBuckets],
    ['-80/0,plasma,multi-dB', 1000, 1024, -80.0, 10.0, 'plasma', SampleType.MultipleBuckets],
    ['4096,-20/20,multi-dB', 1000, 4096, -20.0, 20.0, 'plasma', SampleType.MultipleBuckets],
    ['8192,-60/50,inferno,multi-dB', 1000, 8192, -60.0, 50.0, 'inferno', SampleType.MultipleBuckets],
    ['16384,-100/50,multi-dB', 1000, 16384, -100.0, 50.0, 'inferno', SampleType.MultipleBuckets],
    ['128,white box', 1000, 128, -40.0, 0.0, COLORMAP_DEFAULT, SampleType.WhiteBox],
    ['256,white box', 1000, 256, -30.0, -20.0, 'jet', SampleType.MultipleBuckets],
    ['512,white box', 1000, 512, -60.0, 10.0, 'plasma', SampleType.MultipleBuckets],
    ['defaults,white box', 1000, 1024, -40.0, -10.0, COLORMAP_DEFAULT, SampleType.MultipleBuckets],
    ['defaults,jet,white box', 1000, 1024, -40.0, -10.0, 'jet', SampleType.MultipleBuckets],
    ['2048,jet,white box', 1000, 2048, -40.0, -10.0, 'jet', SampleType.MultipleBuckets],
    ['-80/0,plasma,white box', 1000, 1024, -80.0, 10.0, 'plasma', SampleType.MultipleBuckets],
    ['4096,-20/20,white box', 1000, 4096, -20.0, 20.0, 'plasma', SampleType.MultipleBuckets],
    ['8192,-60/50,inferno,white box', 1000, 8192, -60.0, 50.0, 'inferno', SampleType.MultipleBuckets],
    ['16384,-100/50,white box', 1000, 16384, -100.0, 50.0, 'inferno', SampleType.MultipleBuckets],
  ])(
