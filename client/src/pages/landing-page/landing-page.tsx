                      ...
                      >
                        <div>
                          ...
                          <div className="text-black">
                            ...
                            possible by implementing the Plugins API Plugins run on the backend (not client-side like
                            the spectrogram FFTs)
                          </div>
                        </div>
                      </a>
                      <a
                      ...
                      >
                        <div>
                          ...
                          <div className="text-black">
                            ...
                            RF recordings are stored in the cloud using blob storage, allowing for easy security and
                            data redundancy
                          </div>
                        </div>
                      </a>
