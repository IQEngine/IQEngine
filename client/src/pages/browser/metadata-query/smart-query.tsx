...
export const SmartQuery = () => {
  ...
  const {
    ...
    data: trackData,
    error,
  } = useQueryTrack(CLIENT_TYPE_API, selectedTrack.account, selectedTrack.container, selectedTrack.filepath);
  ...
  return (
    <div className="flex-row p-8">
      <div className="flex justify-center">
        ...
        />
        <button className="btn btn-primary" onClick={handleQuery} type="button">
      ...
      <div className="flex justify-center py-4">
        <div>
          Examples:
          <ul>
            <li>show me all recordings that include LTE</li>
            <li>which recordings were taken in the UHF band?</li>
          </ul>
        </div>
      </div>
