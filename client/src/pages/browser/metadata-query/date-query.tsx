...
export const DateQuery = ({ description, validator, queryName, handleQueryValid, handleQueryInvalid }) => {
  ...
  const handleDateChange = (e) => {
    ...
    let valid =
      name === 'from' ? validator({ from: value, to: dateRange.to }) : validator({ from: dateRange.from, to: value });
    if (valid) {
    ...
    <div className="mb-10">
      <div className="divider mb-8">
        <div className="tooltip" data-tip={description}>
          <button
            disabled={!validator({ from: dateRange.from, to: dateRange.to })}
          ...
          <div className="card-body">
            <div className="flex justify-around">
              ...
              <input
                ...
                type="date"
                placeholder="start"
                className="basis-5/12 input input-bordered w-full"
              />
              <label className="label">
