...
<br />
Organizations who wish to run their own instance for internal use can [click this link](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FIQEngine%2FIQEngine%2Fmain%2Finfra%2Fiqengine.json) to deploy an instance of IQEngine in Azure.
You will need an Azure account; a free one can be created [here](https://azure.microsoft.com/en-us/free/).
