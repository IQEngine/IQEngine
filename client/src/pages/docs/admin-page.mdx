...
You can do this by going to your enterprise application, a link to which can be found on the Overview page of the App Registration, and at the bottom there's a link that says "Go to Enterprise Applications".  Under Users and Groups you should see:
<p align="left">
...
Lastly, within Token Configuration, you have to add a Group Claim, with the Token Type of ID and Access:

<p align="left">
  <img src="/admin_page_token1.png" />
</p>
<br />
<p align="left">
  <img src="/admin_page_token2.png" width="50%"/>
</p>
