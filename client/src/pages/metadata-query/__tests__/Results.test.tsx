  ...
  const raw = [
    {
      "global": {
          ...
          "core:sha512": "bb2f1f9222b172373e81d333a11a866d56611308fd481c7f9c2462e50fec62da1bddd93a94cd9b3e00dcaa6ba4ffe4546022aa50385bc582fc8dd7426740b564",
          "core:offset": null,
          "core:description": "",
          "core:author": "Marc",
          "core:meta_doi": null,
...
vi.mock('@/api/metadata/Queries', async () => {
  const actual = await vi.importActual("@/api/metadata/Queries");
  return {
    queryMeta: vi.fn(() => ({
...
describe('Test Results', () => {
  ...
  test('Basic Rendering', async () => {
    ...
    expect(await screen.getByText(/Sample Count/i)).exist;
  });
});
